...
class PageIndicator {
  ...
  // Need to Parse URL to Build Links (separate helper file?)
  // (must place tag into new URL if it exists)

  // URLs could be any of the following:
  // https://tylerwittig.com/blog
  // https://tylerwittig.com/blog/#/
  // https://tylerwittig.com/blog/tag/Tag-Name/
  // https://tylerwittig.com/blog/tag/Tag-Name/#/
  private function generateLinkPrefix() {
    ...
    if (is_numeric($last)) {
      echo 'is_numeric: '.$last;
    } else {
      echo 'not numeric: '.$last;
    }
  }
